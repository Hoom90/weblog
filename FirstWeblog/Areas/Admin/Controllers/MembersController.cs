...
namespace FirstWeblog.Areas.Admin.Controllers
{
    ...
    public class MembersController : Controller
    {
        ...
        public MembersController(WeblogContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MemberID,Name,Family")] Member member)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MemberID,Name,Family")] Member member)
        {
